...
class Tictactoe < Game
  ...
  #iterate over winning lines and player marks to find if a player has won.
  def winner
  ...
  #new_game is used by minimax to create new boards and games to recursively simulate future moves to determine the next best move for the computer.
